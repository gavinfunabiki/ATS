...
<body class="clearfix <?php echo $bodyClass; ?>">
	...
	<div class="page-container">
		...
		<header class="container-fluid">
			...
			<div class="<?php if($admin != 99) echo 'wrapper1002'; ?>">

				<a href="index.php" title="Pearl.com" class="logo"><img src="<?php echo $app->imgpath; ?>logo.png" alt="Pearl.com" /></a>
                
                <div class="top-links <?php if($admin != 99) echo 'wrapper1002'; ?> adminmode">
                    <ul class="header-links-container Arial">
                     <?php if($admin != 99) { ?>
                        <li class="contactus">Contact us 800-785-2305</li>
                        <li><a href="http://info.pearl.com/help" nt_guid="1">Customer Care</a></li>
                        <li><a href="<?php echo $app->pearlroot; ?>account">My Account</a></li>
                     <?php } ?>
